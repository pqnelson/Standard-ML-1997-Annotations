...
\newcommand{\EtyVar}{{\rm EtyVar}} % new
...
\newcommand{\fundesc}{\nonterminal{fundesc}}
\newcommand{\funid}{\nonterminal{funid}}
\newcommand{\funsigexp}{\nonterminal{funsigexp}}
\newcommand{\funspec}{\nonterminal{funspec}}
\newcommand{\funtyp}{\nonterminal{funtyp}}
\newcommand{\longstridk}{\strid_{1}.\syndots.\strid_{k}}
\newcommand{\longtyconk}{\strid_{1}.\syndots.\strid_{k}.\tycon}
\newcommand{\topdec}{\nonterminal{topdec}}
\newcommand{\program}{\nonterminal{program}}
\newcommand{\sigid}{\nonterminal{sigid}}
\newcommand{\shareq}{\nonterminal{shareq}}
...
\newcommand{\emptydec}
           {\mbox{\qquad}}
\newcommand{\seqdec}
           {\mbox{$\dec_{1}$ \optional{\boxml{;}} $\dec_{2}$}}
\newcommand{\longinfix}
...
%                  $\langle\AND\ \exnbind\rangle$}}
          ...
          % Patterns
\newcommand{\wildpat}{\wildcard} % \mbox{\ml{\_}}}
\newcommand{\recpat}{\mbox{$\langle\labpats\rangle$}}
\newcommand{\wildrec}{\wildcardrow}%{\mbox{\ml{...}}}
...
\newcommand{\barestrbinder}
           {\mbox{$\strid\ 
            \ml{=} $\strexp\ \optional{\optional{\AND\ \strbind}}$}}
\newcommand{\strbindera}
           {\mbox{$\strid\ $\optional{\ml{:}$\ \sigexp$}
            \ml{=} $\strexp\ \optional{\AND\ \strbind}$}}
\newcommand{\barestrbindera}
           {\mbox{$\strid$ \texttt{=} $\strexp$ $\optional{\AND\ \strbind}$}}
...
\newcommand{\transpconstraint}{\mbox{$\strexp$\texttt{:}$\sigexp$}}
\newcommand{\opaqueconstraint}{\mbox{$\strexp$\texttt{\ABSTRACT}$\sigexp$}}
...
\newcommand{\newsharingspec}{\mbox{$\spec$ \texttt{sharing type} $\longtycon_{1}$ \texttt{=} $\syndots$ \texttt{=} $\longtycon_{n}$}}
...
\newcommand{\wheretypesigexp}{\mbox{$\sigexp$ \texttt{where type} $\tyvarseq$ $\longtycon$ =  $\ty$}}
...
\newcommand{\seqtopdec}{\mbox{$\topdec$ $\topdec$}}
\newcommand{\strdecintopdec}{\mbox{$\hbox to12mm{\strdec}\;\optional{\topdec}$}}
\newcommand{\fundecintopdec}{\mbox{$\hbox to12mm{\fundec}\;\optional{\topdec}$}}
\newcommand{\sigdecintopdec}{\mbox{$\hbox to12mm{\sigdec}\;\optional{\topdec}$}}
...
\newcommand{\exval}{e}
\newcommand{\excs}{\nonterminal{ens}}
\newcommand{\exns}{\nonterminal{excons}} % used in the dynamic sem. of mod.
\newcommand{\f}{f}
\newcommand{\m}{m}
\newcommand{\mem}{\nonterminal{mem}}
\newcommand{\M}{M}
...
\def\loadSML{\let\og@comment\comment
  \gdef\comment{\textit{ Comment:\ }}}
\def\unloadSML{\global\let\comment\og@comment}
\newcommand{\comments}{\textit{ Comments:\ }}
% The \ifx#1\relax\else...\fi is necessary because in chapter 5, there
% is an empty rulesec
\newcommand{\rulesec}[2]{\subsection*{\phantomsection{#1}\hfill\fbox{\normalfont$#2$}}\ifx#1\relax\else\addcontentsline{toc}{subsection}{#1}\fi}
%
%\font\msxm=msxm10
%\textfont10=\msxm
